    ...
    <div className="max-w-full mx-auto pb-10">
      ...
      <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} className="mb-8">
        <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-slate-800 tracking-tight flex items-center gap-3">
          <Database className="text-[#60A5FA]" size={36} />
          DB <span className="text-[#60A5FA]">Explorer</span>
        </h2>
      ...
      >
        <div
          ...
          style={{
            boxShadow: aiLoading
              ? "0 0 30px rgba(96,165,250,0.15), 8px 8px 16px rgba(0,0,0,0.05), -8px -8px 16px rgba(255,255,255,0.8)"
        ...
        >
          ...
          <div
            ...
            style={{
              background: "linear-gradient(90deg, #60A5FA, #A78BFA, #10B981, #FDBA74, #60A5FA)",
        ...
        <div className="flex items-center justify-between mb-5">
          ...
          <div className="flex items-center gap-2">
            <motion.button
              ...
              className="p-2.5 rounded-full bg-[#F5F5F0] shadow-[4px_4px_8px_rgba(0,0,0,0.05),-4px_-4px_8px_rgba(255,255,255,0.8)] text-slate-400 hover:text-[#60A5FA] transition-colors"
              title="Refresh Data"
            >
              <RefreshCw size={16} />
            </motion.button>
          ...
          {filters.map((filter, i) => (
            <div key={i} className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
              ...
              <select
                ...
                className="flex-1 sm:max-w-[200px] bg-[#F5F5F0] shadow-[inset_4px_4px_8px_rgba(0,0,0,0.05),inset_-4px_-4px_8px_rgba(255,255,255,0.8)] rounded-full py-3 px-5 outline-none focus:ring-2 focus:ring-[#60A5FA]/30 transition-all text-slate-600 border-none cursor-pointer text-sm font-medium"
              >
              ...
              <div className="flex-1 relative">
                ...
                <input
                  ...
                  className="w-full bg-[#F5F5F0] shadow-[inset_4px_4px_8px_rgba(0,0,0,0.05),inset_-4px_-4px_8px_rgba(255,255,255,0.8)] rounded-full py-3 pl-11 pr-5 outline-none focus:ring-2 focus:ring-[#60A5FA]/30 transition-all text-slate-600 placeholder:text-slate-400 border-none text-sm"
                />
              </div>
                        ...
                        {editingRow === rowIdx ? (
                          col === getPrimaryKey(activeTable) ? (
                            ...
                            <input
                              ...
                              className="w-full min-w-[100px] bg-[#F5F5F0] shadow-[inset_3px_3px_6px_rgba(0,0,0,0.05),inset_-3px_-3px_6px_rgba(255,255,255,0.8)] rounded-xl py-2 px-3 outline-none focus:ring-2 focus:ring-[#60A5FA]/30 transition-all text-slate-700 border-none text-xs font-medium"
                            />
                          )
                        ) : (
                          <span
                    ...
                    <td className="px-5 py-3.5 text-center sticky right-0 bg-[#F5F5F0]">
                      {editingRow === rowIdx ? (
                        ...
                        <motion.button
                          ...
                          className="p-2 rounded-full bg-[#F5F5F0] shadow-[4px_4px_8px_rgba(0,0,0,0.05),-4px_-4px_8px_rgba(255,255,255,0.8)] text-slate-400 hover:text-[#60A5FA] transition-colors mx-auto"
                          title="Edit row"
                        >
                          <Edit3 size={14} />
                        </motion.button>
