              ...
              <div className="flex justify-between items-start gap-4">
                <div className="flex flex-col gap-1">
                  <div className="flex items-center gap-2">
                    ...
                    {b.has_rsvp && <span className="bg-[#60A5FA]/10 text-[#60A5FA] text-[9px] font-bold uppercase px-2 py-0.5 rounded flex items-center gap-1"><ListChecks size={10}/> Quick Poll</span>}
                  </div>
